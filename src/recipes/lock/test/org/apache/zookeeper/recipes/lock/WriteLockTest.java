            ...
            for (int i = 0; i < nodes.length; i++) {
                ...
                if (node != null) {
                    ...
                    if (workAroundClosingLastZNodeFails && i == nodes.length - 1) {
                        System.out.println("Not closing ZookeeperClientTest: " + i + " due to bug!");
                    } else {
                        System.out.println("Closing ZookeeperClientTest: " + i);
                        node.getZookeeper().close();
                        System.out.println("Closed ZookeeperClientTest: " + i);
                    }
                }
            }
        }
