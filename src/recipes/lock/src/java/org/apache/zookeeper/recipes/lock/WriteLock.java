...
public class WriteLock extends ProtocolSupport {
    ...
    /**
     * ZookeeperClientTest contructor for writelock
     * @param zookeeper ZookeeperClientTest client instance
    ...
    /**
     * ZookeeperClientTest contructor for writelock with callback
     * @param zookeeper the ZookeeperClientTest client instance
     * @param dir the parent path you want to use for locking
     ...
     * if it cannot connect to ZookeeperClientTest.
     */
    ...
    private  class LockZooKeeperOperation implements ZooKeeperOperation {
         ...
         * @param zookeeper teh ZookeeperClientTest client
