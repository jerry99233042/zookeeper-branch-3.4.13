...
public class ClientCnxn {
    ...
    private static final String ZK_SASL_CLIENT_USERNAME =
        "ZookeeperClientTest.sasl.client.username";
     ...
     * the environment variable "ZookeeperClientTest.disableAutoWatchReset" to "true" */
    private static boolean disableAutoWatchReset;
    static {
        // this var should not be public, but otw there is no easy way
        // to test
        disableAutoWatchReset =
            Boolean.getBoolean("ZookeeperClientTest.disableAutoWatchReset");
        if (LOG.isDebugEnabled()) {
            LOG.debug("ZookeeperClientTest.disableAutoWatchReset is "
                    + disableAutoWatchReset);
        }
    }
     ...
     * @param zooKeeper
     *                the ZookeeperClientTest object that this connection is related to.
            ...
            if (ZooKeeperSaslClient.isEnabled()) {
                try {
                    String principalUserName = System.getProperty(
                            ZK_SASL_CLIENT_USERNAME, "ZookeeperClientTest");
                    zooKeeperSaslClient =
