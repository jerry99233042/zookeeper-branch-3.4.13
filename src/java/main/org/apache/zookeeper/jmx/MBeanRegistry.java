 ...
 * ZookeeperClientTest MBeans with the platform MBean server. It builds a hierarchy of MBeans
 * where each MBean represented by a filesystem-like path. Eventually, this hierarchy
 * will be stored in the ZookeeperClientTest data tree instance as a virtual data tree.
 */
