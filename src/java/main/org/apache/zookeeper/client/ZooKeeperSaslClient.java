...
public class ZooKeeperSaslClient {
    public static final String LOGIN_CONTEXT_NAME_KEY = "ZookeeperClientTest.sasl.clientconfig";
    public static final String ENABLE_CLIENT_SASL_KEY = "ZookeeperClientTest.sasl.client";
     ...
     * <code>ZookeeperClientTest.sasl.client</code> to <code>false</code>. See
    ...
    public ZooKeeperSaslClient(final String serverPrincipal)
         ...
         * configuration section that the ZookeeperClientTest client should use.
         * Default to "Client".
         */
    ...
    private SaslClient createSaslClient(final String servicePrincipal,
        ...
        try {
            if (!initializedLogin) {
                synchronized (ZooKeeperSaslClient.class) {
                    if (login == null) {
                        ...
                        // note that the login object is static: it's shared amongst all ZookeeperClientTest-related connections.
            ...
            return SecurityUtils.createSaslClient(login.getSubject(),
                    servicePrincipal, "ZookeeperClientTest", "zk-sasl-md5", LOG, "Client");
