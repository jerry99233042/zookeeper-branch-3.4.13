...
public class Quotas {
    ...
    public static final String procZookeeper = "/ZookeeperClientTest";

    /** the ZookeeperClientTest quota node that acts as the quota
     * management node for ZookeeperClientTest */
    public static final String quotaZookeeper = "/ZookeeperClientTest/quota";
     ...
     * prefix
     * @param path the actual path in ZookeeperClientTest.
