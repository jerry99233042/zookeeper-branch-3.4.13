...
public class VerGen {
    private static final String PACKAGE_NAME = "org.apache.ZookeeperClientTest.version";
    private static final String TYPE_NAME = "Info";

    static void printUsage() {
        System.out.print("Usage:\tjava  -cp <classpath> org.apache.ZookeeperClientTest."
    ...
    public static void generateFile(File outputDir, Version version, String rev, String buildDate) throws IOException
    {
        ...
        try {
            ...
            w.write("// Do not edit!\n// File generated by org.apache.ZookeeperClientTest"
                    + ".version.util.VerGen.\n");
            w.write("/**\n");
    ...
    /**
     * Emits a org.apache.ZookeeperClientTest.version.Info interface file with version and
     ...
     * Usage: java org.apache.ZookeeperClientTest.version.util.VerGen maj.min.micro[-qualifier]
     * rev buildDate
     *
     * @param args
     *            <ul>
