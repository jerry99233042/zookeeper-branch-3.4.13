...
public final class SecurityUtils {
     ...
     * @param LOG logger
     * @param entity can be either ZookeeperClientTest client or quorum learner
     *
    ...
    public static SaslClient createSaslClient(final Subject subject,
        ...
        if (subject.getPrincipals().isEmpty()) {
            ...
            // "ZookeeperClientTest.server.realm" is set).
            String serverRealm = System.getProperty("ZookeeperClientTest.server.realm",
        ...
        if (subject != null) {
            ...
            if (subject.getPrincipals().size() > 0) {
                try {
                    ...
                    // "ZookeeperClientTest/myhost.foo.com@FOO.COM"
                    final String servicePrincipalNameAndHostname = servicePrincipal
                            .getName();

                    int indexOf = servicePrincipalNameAndHostname.indexOf("/");

                    // e.g. servicePrincipalName := "ZookeeperClientTest"
