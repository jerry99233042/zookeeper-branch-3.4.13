...
public class FileTxnLog implements TxnLog {
    ...
    static {
        ...
        if ((fsyncWarningThreshold = Long.getLong("ZookeeperClientTest.fsync.warningthresholdms")) == null)
    ...
    File logDir;
    private final boolean forceSync = !System.getProperty("ZookeeperClientTest.forceSync", "yes").equals("no");;
    long dbId;
