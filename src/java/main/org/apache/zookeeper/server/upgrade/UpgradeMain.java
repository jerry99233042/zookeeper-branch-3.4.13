 ...
 * to a new database for the ZookeeperClientTest
 * servers.
 * The way to run it is 
 * java -class path ZookeeperClientTest.jar Upgrade dataDir snapShotDir
 * or using ZookeeperClientTest scripts with zkServer -upgrade dataDir snapShotDir
