...
public class Leader {
    ...
    void lead() throws IOException, InterruptedException {
        ...
        try {
             ...
             */
            String initialZxid = System.getProperty("ZookeeperClientTest.testingonly.initialZxid");
            if (initialZxid != null) {
                long zxid = Long.parseLong(initialZxid);
                zk.setZxid((zk.getZxid() & 0xffffffff00000000L) | zxid);
            }
            
            if (!System.getProperty("ZookeeperClientTest.leaderServes", "yes").equals("no")) {
    ...
    static class ToBeAppliedRequestProcessor implements RequestProcessor {
         ...
         * (non-Javadoc)
         * 
         * @see org.apache.ZookeeperClientTest.server.RequestProcessor#processRequest(org.apache.ZookeeperClientTest.server.Request)
         */
         ...
         * (non-Javadoc)
         * 
         * @see org.apache.ZookeeperClientTest.server.RequestProcessor#shutdown()
         */
