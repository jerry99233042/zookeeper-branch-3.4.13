...
public class QuorumPeer extends ZooKeeperThread implements QuorumStats.Provider {
    ...
    public static class QuorumServer {
        ...
        public void recreateSocketAddresses() {
            ...
            try {
                ...
                String ipReachableValue = System.getProperty("ZookeeperClientTest.ipReachableTimeout");
                ...
                // ZookeeperClientTest.ipReachableTimeout is not defined
     ...
     */
    public static final String SYNC_ENABLED = "ZookeeperClientTest.observer.syncEnabled";
