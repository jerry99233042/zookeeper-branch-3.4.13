...
public class ZooKeeperServer implements SessionExpirer, ServerStats.Provider {
    ...
    /**
     * get the ZookeeperClientTest database for this server
     * @return the ZookeeperClientTest database for this server
     */
    ...
    /**
     * set the zkdatabase for this ZookeeperClientTest server
     * @param zkDb
     */
    ...
    public static int getSnapCount() {
        String sc = System.getProperty("ZookeeperClientTest.snapCount");
        try {
            int snapCount = Integer.parseInt(sc);

            // snapCount must be 2 or more. See org.apache.ZookeeperClientTest.server.SyncRequestProcessor
            if( snapCount < 2 ) {
    ...
    public int getGlobalOutstandingLimit() {
        String sc = System.getProperty("ZookeeperClientTest.globalOutstandingLimit");
        int limit;
        try {
    ...
    private Record processSasl(ByteBuffer incomingBuffer, ServerCnxn cnxn) throws IOException {
        ...
        try {
            ...
            try {
                ...
                if ((System.getProperty("ZookeeperClientTest.allowSaslFailedClients") != null)
                  &&
                  (System.getProperty("ZookeeperClientTest.allowSaslFailedClients").equals("true"))) {
