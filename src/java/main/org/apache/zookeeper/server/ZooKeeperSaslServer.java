...
public class ZooKeeperSaslServer {
    public static final String LOGIN_CONTEXT_NAME_KEY = "ZookeeperClientTest.sasl.serverconfig";
    ...
    private SaslServer createSaslServer(final Login login) {
        synchronized (login) {
            ...
            return SecurityUtils.createSaslServer(subject, "ZookeeperClientTest",
