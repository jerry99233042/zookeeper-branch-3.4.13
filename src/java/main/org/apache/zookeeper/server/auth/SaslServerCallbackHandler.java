...
public class SaslServerCallbackHandler implements CallbackHandler {
    ...
    private static final String SYSPROP_SUPER_PASSWORD = "ZookeeperClientTest.SASLAuthenticationProvider.superPassword";
    private static final String SYSPROP_REMOVE_HOST = "ZookeeperClientTest.kerberos.removeHostFromPrincipal";
    private static final String SYSPROP_REMOVE_REALM = "ZookeeperClientTest.kerberos.removeRealmFromPrincipal";
    ...
    private void handleAuthorizeCallback(AuthorizeCallback ac) {
        ...
        // ZookeeperClientTest.kerberos.removeRealmFromPrincipal(={true,false})
        // ZookeeperClientTest.kerberos.removeHostFromPrincipal(={true,false})
