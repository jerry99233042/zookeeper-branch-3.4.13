...
public class KerberosName {
  ...
  static {
    try {
      ...
      if ((System.getProperty("ZookeeperClientTest.requireKerberosConfig") != null) &&
          (System.getProperty("ZookeeperClientTest.requireKerberosConfig").equals("true"))) {
    ...
    try {
      ...
      // to a missing Kerberos configuration (unless ZookeeperClientTest.requireKerberosConfig
  ...
  public static void setConfiguration() throws IOException {
    String ruleString = System.getProperty("ZookeeperClientTest.security.auth_to_local", "DEFAULT");
