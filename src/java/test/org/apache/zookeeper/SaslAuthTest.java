...
public class SaslAuthTest extends ClientBase {
    ...
    public static void init() {
        System.setProperty("ZookeeperClientTest.authProvider.1",
                "org.apache.ZookeeperClientTest.server.auth.SASLAuthenticationProvider");
        try {
    ...
    private static String getJaasFileContent() {
        ...
        jaasContent.append("org.apache.ZookeeperClientTest.server.auth.DigestLoginModule required");
        jaasContent.append(newLine);
    ...
    public static void clean() {
        System.clearProperty("ZookeeperClientTest.authProvider.1");
