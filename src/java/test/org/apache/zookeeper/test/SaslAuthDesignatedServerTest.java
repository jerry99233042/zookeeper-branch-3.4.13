...
public class SaslAuthDesignatedServerTest extends ClientBase {
    ...
    static {
        System.setProperty("ZookeeperClientTest.authProvider.1","org.apache.ZookeeperClientTest.server.auth.SASLAuthenticationProvider");
         ...
         */
        conf.addSection("Server", "org.apache.ZookeeperClientTest.server.auth.DigestLoginModule",
                        "user_myuser", "wrongpassword");

        conf.addSection("MyZookeeperServer", "org.apache.ZookeeperClientTest.server.auth.DigestLoginModule",
                        "user_myuser", "mypassword");

        conf.addSection("Client", "org.apache.ZookeeperClientTest.server.auth.DigestLoginModule",
