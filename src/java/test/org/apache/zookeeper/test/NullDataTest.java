...
public class NullDataTest extends ClientBase implements StatCallback {
    ...
    public void setUp() throws Exception {
        ...
        snapCount = System.getProperty("ZookeeperClientTest.snapCount", "1024");
        System.setProperty("ZookeeperClientTest.snapCount", "10");
        super.setUp();
    }
    
    @Override
    public void tearDown() throws Exception {
        System.setProperty("ZookeeperClientTest.snapCount", snapCount);
        super.tearDown();
    }
