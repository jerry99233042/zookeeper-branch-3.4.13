...
public class ACLTest extends ZKTestCase implements Watcher {
    ...
    public void testDisconnectedAddAuth() throws Exception {
        ...
        f.startup(zks);
        try {
            LOG.info("starting up the ZookeeperClientTest server .. waiting");
     ...
     * (non-Javadoc)
     *
     * @see org.apache.ZookeeperClientTest.Watcher#process(org.apache.ZookeeperClientTest.WatcherEvent)
     */
